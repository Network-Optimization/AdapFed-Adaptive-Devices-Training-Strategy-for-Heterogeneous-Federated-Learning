...
def load_dataset(args):
    ...
    if args.dataset == "Shakespeare":
        ...
        if args.dataset == "EMNIST":
            ...
            # local_data_path = "/data/test/zhouying/data/EMNIST/raw"
            ...
            # train = True，从训练集create数据
            # train_data = datasets.EMNIST(root="/data/test/zhouying/data/EMNIST", split="byclass", download=False, transform=transform, train=True)
            # # test = False，从测试集create数据
            # test_data = datasets.EMNIST(root="/data/test/zhouying/data/EMNIST", split="byclass", download=False, transform=transform, train=False)
            # 指定本地数据路径
            # local_data_path = "/data/test/zhouying/data/EMNIST"

            # # 使用本地路径加载训练数据
            # train_data = datasets.EMNIST(root=local_data_path, split="byclass", download=False, transform=transform, train=True)

            # # 使用本地路径加载测试数据，设置train=False
            # test_data = datasets.EMNIST(root=local_data_path, split="byclass", download=False, transform=transform, train=False)
